...
namespace UIClient
{
    public class PrintRendering
    {
        ...
        public static void printRendering(string title, DataGridView dataGridView1, System.Drawing.Printing.PrintPageEventArgs e)
        {
            try
            {
                printStart(dataGridView1);
                //Set the left margin
                ...
                while (iRow <= dataGridView1.Rows.Count - 1)
                {
                    ...
                    else
                    {
                        ...
                        {
                            //Draw Header
                            e.Graphics.DrawString(title, new Font(dataGridView1.Font, FontStyle.Bold),
                                    Brushes.Black, e.MarginBounds.Left, e.MarginBounds.Top -
                                    e.Graphics.MeasureString(title, new Font(dataGridView1.Font,
                            ...
                            e.Graphics.DrawString(strDate, new Font(dataGridView1.Font, FontStyle.Bold),
                                    ...
                                    e.Graphics.MeasureString(title, new Font(new Font(dataGridView1.Font,
        ...
        private static void printStart(DataGridView dataGridView1)
        {
            try
            {
